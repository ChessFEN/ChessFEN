    ...
    return {
      ...
      link: function (scope, element, attrs) {
        ...
        var wheelHandler = function (event) {
          if (attrs.hasOwnProperty('onScroll')) {
        ...
        scope.wheelTo =function(delta) {
          var wheelSpeed = 40;
          var d = 0, w = delta, n = 225, n1 = n - 1;
          var delta;
